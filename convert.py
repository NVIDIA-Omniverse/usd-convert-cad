...
def print_usage() -> None:
    ...
    print("   python convert.py model.jt model.usd --backend hoops_core")
    ...
    print("   python convert.py model.jt model.usd --backend auto --report model.json --quiet")
    print("   python convert.py model.jt model.usd --backend auto --report model.json --quiet --log model.log")
    print("   python convert.py site.dgn site.usd --backend hoops_core")
